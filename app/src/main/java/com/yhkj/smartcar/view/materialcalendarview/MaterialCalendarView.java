package com.yhkj.smartcar.view.materialcalendarview;
...
import com.yhkj.smartcar.view.materialcalendarview.format.ArrayWeekDayFormatter;
import com.yhkj.smartcar.view.materialcalendarview.format.DateFormatTitleFormatter;
import com.yhkj.smartcar.view.materialcalendarview.format.DayFormatter;
import com.yhkj.smartcar.view.materialcalendarview.format.MonthArrayTitleFormatter;
import com.yhkj.smartcar.view.materialcalendarview.format.TitleFormatter;
import com.yhkj.smartcar.view.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
     ...
     */
    public static final int DEFAULT_TILE_SIZE_DP = 50;
    ...
    private List<CalendarDay> mShowListData = new ArrayList<>();
    public void setTransverter(List<String> listdata){
//        String[] maxYm = null, minYm = null;
//        listdata.add("2017-6");
        for (int i=listdata.size()-1; i>=0;i--){
            ...
            mShowListData.add(CalendarDay.from(year,month,1));
        }

//        state().edit()
//                .setMaximumDate(CalendarDay.from(Integer.parseInt(maxYm[0]), Integer.parseInt(maxYm[1])-1, 32))
//                .setMinimumDate(CalendarDay.from(Integer.parseInt(minYm[0]), Integer.parseInt(minYm[1])-1, 1))
//                .commit();
//        setCurrentDate(CalendarDay.from(Integer.parseInt(maxYm[0]),Integer.parseInt(maxYm[1])-1,1));
    }
    ...
    private final ViewPager.OnPageChangeListener pageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            //
//            currentMonth = modOffsetShowMonth(adapter.getItem(position));
...
//                    .commit();
            ...
            final int tileSize = a.getLayoutDimension(R.styleable.MaterialCalendarView_mcv_tileSize, 0);
            if (tileSize > INVALID_TILE_DIMENSION) {
                setTileSize(tileSize);
            }

            final int tileWidth = a.getLayoutDimension(R.styleable.MaterialCalendarView_mcv_tileWidth, 0);
            if (tileWidth > INVALID_TILE_DIMENSION) {
                setTileWidth(tileWidth);
            }

            final int tileHeight = a.getLayoutDimension(R.styleable.MaterialCalendarView_mcv_tileHeight, 0);
...
//            ));
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.mipmap.ic_nor_arrowleft);
            }
...
//        }
    ...
    public void show(){
        ...
        newState()
                .setFirstDayOfWeek(firstDayOfWeek)
                .setCalendarDisplayMode(CalendarMode.values()[0])
                .setMinimumDate(mShowListData.get(mShowListData.size()-1))
                .setMaximumDate(CalendarDay.from(mShowListData.get(0).getYear(),mShowListData.get(0).getMonth(),31))
                .commit();
...
//         Adapter is created while parsing the TypedArray attrs, so setup has to happen after
    ...
    private void setupChildren() {
        ...
        RelativeLayout.LayoutParams buttonPastlayoutParams = new RelativeLayout.LayoutParams(dpToPx(20), dpToPx(20));
        buttonPastlayoutParams.addRule(RelativeLayout.CENTER_VERTICAL);
        buttonPastlayoutParams.addRule(RelativeLayout.LEFT_OF,R.id.mcv_title);
        buttonPastlayoutParams.setMargins(0,0,dpToPx(20),0);
        topbar.addView(buttonPast, buttonPastlayoutParams);

        buttonFuture.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        RelativeLayout.LayoutParams buttonFuturelayoutParams = new RelativeLayout.LayoutParams(dpToPx(20), dpToPx(20));
        buttonFuturelayoutParams.addRule(RelativeLayout.CENTER_VERTICAL);
        buttonFuturelayoutParams.addRule(RelativeLayout.RIGHT_OF,R.id.mcv_title);
        buttonFuturelayoutParams.setMargins(dpToPx(20),0,0,0);
        topbar.addView(buttonFuture, buttonFuturelayoutParams);

        View view = new View(getContext());
        view.setBackgroundResource(R.color.car_blue);
        ...
        topbar.addView(view,viewlayoutParams);
...
//        buttonPast.setImageDrawable(icon);
        buttonPast.setImageResource(R.mipmap.ic_nor_arrowleft);
    }
...
//        buttonFuture.setImageDrawable(icon);
        buttonFuture.setImageResource(R.mipmap.ic_nor_arrowright);
    }
    ...
    public boolean getTopbarVisible() {
        ...
        return topbar!=null ?  (topbar.getVisibility() == View.VISIBLE) : false;
    }
    ...
    private int getWeekCountBasedOnMode() {
        ...
        if (calendarMode!=null ){
            weekCount = calendarMode.visibleWeeksCount;
    ...
    private void commit(State state) {
        ...
        switch (calendarMode) {
            case MONTHS:
                newAdapter = new MonthPagerAdapter(this,null).setFiddleData(mShowListData);
