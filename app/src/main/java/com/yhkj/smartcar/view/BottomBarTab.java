package com.yhkj.smartcar.view;
...
//        addView(mTvUnreadCount);
    ...
    private int[] SELECT_ICON = new int[]{
        R.mipmap.ic_nor_home_2,
        R.mipmap.ic_nor_car_2,
        R.mipmap.ic_nor_mine_2,
    };

    private int[] UNSELECT_ICON = new int[]{
            R.mipmap.ic_nor_home,
            R.mipmap.ic_nor_car_1,
            R.mipmap.ic_nor_mine_1,
    };
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setImageResource(SELECT_ICON[mTabPosition]);
            if (mTvTitle!=null)
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.car_blue));
        } else {
            if (mTvTitle!=null)
                mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.white));
            mIcon.setImageResource(UNSELECT_ICON[mTabPosition]);
        }
    }
