...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = 0xFF1a8cfc;
    private final int DEFAULT_COLOR_PRIMARY_DARK = 0xFF1a8cfc;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setColor(isOn ? colorPrimary : 0xFF414141);
        ...
        paint.setColor(isOn ? colorPrimaryDark : 0xFF414141);
        canvas.drawPath(bPath, paint);
        canvas.restore();
