...
import static com.yhkj.smartcar.view.materialcalendarview.MaterialCalendarView.showDecoratedDisabled;
import static com.yhkj.smartcar.view.materialcalendarview.MaterialCalendarView.showOtherMonths;
import static com.yhkj.smartcar.view.materialcalendarview.MaterialCalendarView.showOutOfRange;
/**
...
//                    new int[]{android.R.attr.state_enabled}, Color.WHITE));
            if (isDecoratedDisabled)
                setTextColor(getResources().getColor(R.color.textColor_actionsheet_title));
            else
                setTextColor(getResources().getColor(R.color.white));
