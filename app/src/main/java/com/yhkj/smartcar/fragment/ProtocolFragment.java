...
public class ProtocolFragment extends BaseToolbarFragment {
    ...
    protected void initData() {
        ...
        SmartCarApi.getInstance().getServiceProtocol(_mActivity, new ApiCallback<ServerProtocolBean.DataBean>() {
            @Override
            public void onStart() {
            ...
            @Override
            public void onNext(ServerProtocolBean.DataBean dataBean) {
                sDialog.dismissWithDelay(500);
                mWebView.loadDataWithBaseURL(null,dataBean.getService(),"text/html","UTF-8",null);
            }
        });
    }
