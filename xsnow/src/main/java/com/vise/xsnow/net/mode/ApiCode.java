...
public class ApiCode {
    ...
    public static class Response {
        ...
        //手机号或密码错误
        public static final int ERROR_PHONE_PWD = 1001;

        //AccessToken格式不正确
        public static final int ACCESS_TOKEN_ERROR = 2001;

        //AccessToken失败
        public static final int ACCESS_TOKEN_FAILD = 2002;

        //AccessToken错误或已过期
        public static final int ACCESS_TOKEN_EXPIRED = 2003;
////
////        //RefreshToken错误或已过期
